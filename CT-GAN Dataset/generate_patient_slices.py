...
def process_dataset(csv_path, scan_folder, output_dir, annotate, subfolder_name):
    output_base = os.path.join(output_dir, subfolder_name)
    ...
    for f in files:
        ...
        save_slices(scan_uuid, scan, raw_slices, tampered_df, output_base, annotate)
...
def main():
    ...
    for dataset in datasets:
        process_dataset(
            ...
            subfolder_name=dataset['subfolder_name']
        )
